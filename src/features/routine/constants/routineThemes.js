export const ROUTINE_THEMES = {
  morning: {
    background: '#945C2D', screenBackground: '#FFF9F1', heading: '#945C2D', text: '#945C2D', subtext: '#BE9D82', revtext: '#FFF9F1',
    card: 'rgba(255,255,255,0.90)', border: 'transparent', divider: '#F0E5DB', number: '#BE9D82',
  ...
  evening: {
    ...
    card: 'rgba(255,255,255,0.10)', border: 'rgba(255,255,255,0.28)', divider: 'rgba(255,255,255,0.25)', number: 'rgba(255,255,255,0.10)',
